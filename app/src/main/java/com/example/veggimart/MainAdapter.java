...
public class MainAdapter extends FirebaseRecyclerAdapter <MainModel,MainAdapter.myViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull @NotNull myViewHolder holder,final int position, @NonNull @NotNull MainModel model) {
        ...
        holder.expire.setText(model.getExpire());
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText number = view.findViewById(R.id.txtNumber);
                EditText cvv = view.findViewById(R.id.txtCvv);
                EditText expire = view.findViewById(R.id.txtExpire);
                ...
                expire.setText(model.getExpire());
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        ...
        CircleImageView img;
        TextView name,number,cvv,expire;
        ...
        public myViewHolder(@NonNull @NotNull View itemView) {
            ...
            expire = (TextView)itemView.findViewById(R.id.expiretext);
